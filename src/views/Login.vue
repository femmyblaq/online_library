<template>
  <div id="login" class="d-flex justify-content-center align-items-center">
          ...
          <div class="card-body p-4">
            <div class="card-title mb-4 d-flex justify-content-center">
              <router-link :to="{ name: 'Home' }">
                <img
                  style="width: 150px"
                  src="../assets/Category_img/icons/LibraryTuT_black.png"
                  alt=""
                />
              </router-link>
            </div>
    ...
    <div class="card-join d-flex shadow">
      <div class="first-card p-3">
        <div class="card-brand mb-4 d-flex justify-content-center">
          <router-link :to="{ name: 'Home' }">
            <img
              style="width: 150px"
              src="../assets/Category_img/icons/LibraryTuT_black.png"
        ...
        <form @submit.prevent="onSubmit">
          ...
          <div class="form-group mt-3" :class="{ invalid: $v.password.$error }">
            <label for="">Password</label>
            <input
              type="password"
              @blur="$v.password.$touch()"
      ...
      <div class="second-card p-3">
        <div
          class="card-content d-flex align-item-center justify-content-center text-center"
        >
          <div>
            <h2>Sign up</h2>
            <p>
...
#login {
  ...
  .card-join .first-card,
  .card-join .second-card {
    width: 400px;
    height: 350px;
